...
class AddEditViewController: UIViewController {
    ...
    @IBOutlet weak var dpRealeaseDate: UIDatePicker!
    ...
    override func viewDidLoad() {
        ...
        if game != nil {
            ...
            if let releaseDate = game.releaseDate {
                dpRealeaseDate.date = releaseDate
            }
            if game.cover != nil {
    ...
    @IBAction func addEditCover(_ sender: UIButton) {
        ...
        if UIImagePickerController.isSourceTypeAvailable(.camera){
            let cameraAction = UIAlertAction(title: "Camêra", style: .default) { (action) in
    ...
    @IBAction func addEditGame(_ sender: Any) {
        ...
        game.releaseDate = dpRealeaseDate.date
